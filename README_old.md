...
- liste zakupow,
- ustawienia konta,
- dwa tryby danych i autoryzacji: `localStorage`, `Firebase` oraz `Google`
...
Projekt ma dwa tryby lokalnej pracy:
...
Można również korzystać z aplikacji poprzez stronę https://co-mam-w-lodowce.vercel.app/
